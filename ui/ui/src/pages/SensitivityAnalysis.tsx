  ...
  return (
    <div className="w-full">
      <div className="flex justify-between items-start mb-8 flex-wrap gap-4">
        <div>
          <h1 className="text-3xl font-semibold text-black mb-2">Sensitivity & What-If Analysis</h1>
      ...
      <div className="bg-white rounded-card p-6 shadow-sm mb-6">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {['Ocean Freight Rate', 'Railway Freight Rate', 'Port Handling Costs', 'Demurrage Rate'].map((param, idx) => (
              <div key={idx}>
                ...
                <input type="range" min="-50" max="50" defaultValue="0" className="w-full accent-blue-600" />
          ...
          <button className="px-5 py-2.5 rounded-full bg-blue-600 text-white font-medium text-sm cursor-pointer transition-all hover:bg-blue-600-dark hover:shadow-md">
            Run Simulation
          </button>
        </div>
      </div>
      ...
      <div className="bg-white rounded-card p-6 shadow-sm mb-6">
        ...
        <div className="h-80">
          <ResponsiveContainer width="100%" height="100%">
            <RechartsBarChart data={tornadoData} layout="vertical">
